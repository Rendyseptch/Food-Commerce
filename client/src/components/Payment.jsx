  ...
  render() {
    return (
      <main class="page">
          ...
          <div class="container">
            ...
            <form>
              <div class="products">
                      ...
                      <div>
                        ...
                        <span className="m-2" style={{ float: "left" }}>
                          ...
                          <small className="text-success">
                            ...
                            people
                            <br></br>
                            Price Per Serving: Rp. {foodItem.price}
                          </small>
                        </span>
                      </div>
                      <span className="text-muted">
                        Rp. {foodItem.price * foodItem.counter}
                      </span>
                    </li>
                  ))}
                </ul>
                ...
                <div class="total">
                  Grand Total
                  <span class="price">Rp. {this.props.billAmount}</span>
                </div>
              </div>
              ...
              <div class="card-details">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-sm-12">
                    ...
                    >
                      Proceed to Place an order of Rp. {this.props.billAmount}
                    </button>
                  </div>
                </div>
              </div>
        ...
        <footer>
          <p>Foody Grown© 2024 All Rights Reserved</p>
          <p>Rendy Septian</p>
        </footer>
      </main>
    );
